...
SELECT model_id + 1000 FROM Rifle_Model_Table;
...
SELECT model_id + 1000, 1000 + model_id * 100, model_id + 1000, '2024-01-01', '2024-12-31' FROM Rifle_Model_Table;
...
INSERT INTO Price_Table (price_id, price, item_id, date_start, date_end)
SELECT mb_id + 10000, 200 + mb_id * 50, mb_id + 10000, '2024-01-01', '2024-12-31' FROM Muzzle_Break_Table;
...
INSERT INTO Price_Table (price_id, price, item_id, date_start, date_end)
SELECT mag_id + 200000, 20 + mag_id * 5, mag_id + 200000, '2024-01-01', '2024-12-31' FROM Mag_Table;

-- Вставка данных в таблицу Item_Table из Handguard_Table
INSERT INTO Item_Table (item_id)
SELECT hg_id + 300000 FROM Handguard_Table;

-- Вставка данных в таблицу Price_Table для каждого цевья
INSERT INTO Price_Table (price_id, price, item_id, date_start, date_end)
SELECT hg_id + 300000, 50 + hg_id * 10, hg_id + 300000, '2024-01-01', '2024-12-31' FROM Handguard_Table;

-- Вставка данных в таблицу Item_Table из Tactical_Modification_Table
INSERT INTO Item_Table (item_id)
SELECT mod_id + 400000 FROM Tactical_Modification_Table;

-- Вставка данных в таблицу Price_Table для тактических модификаций
INSERT INTO Price_Table (price_id, price, item_id, date_start, date_end)
SELECT mod_id + 400000, 80 + mod_id * 10, mod_id + 400000, '2024-01-01', '2024-12-31' FROM Tactical_Modification_Table;
