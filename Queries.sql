...
JOIN Price_Table p ON r.model_id = p.item_id
...
FROM Rifle_Model_Table r
LEFT JOIN Handguard_Table h ON r.hg_type = h.mount_type
...
FROM Tactical_Modification_Table t
JOIN Handguard_Table h ON t.mount_type = h.mount_type
JOIN Rifle_Model_Table r ON h.mount_type = r.hg_type
...
FROM Rifle_Model_Table r
JOIN Handguard_Table h ON r.hg_type = h.mount_type
